...
directory_path = r"C:\Users\UQBU\OneDrive - PETROBRAS\Documents\Particular\Doutorado\PPGI 2022\GPT\Projeto final\OM\Github\Petroles\PetroVEC_OeG_Word2vec_300d"

# Construir o caminho relativo para o arquivo
vectors_path = os.path.join(directory_path, "PetroVec-OeG-300d.model.wv.vectors.npy")
syn1neg_path = os.path.join(directory_path, "PetroVec-OeG-300d.model.trainables.syn1neg.npy")
model_path = os.path.join(directory_path, "PetroVec-OeG-300d.model")
