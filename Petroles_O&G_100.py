...
directory_path = r"C:\Users\UQBU\OneDrive - PETROBRAS\Documents\Particular\Doutorado\PPGI 2022\GPT\Projeto final\OM\Github\Petroles\Petrovec_OeG_Word2vec"

# Construir o caminho relativo para o arquivo
vectors_path = os.path.join(directory_path, "publico-COMPLETO-100.txt.model.wv.vectors.npy")
syn1neg_path = os.path.join(directory_path, "publico-COMPLETO-100.txt.model.trainables.syn1neg.npy")
model_path = os.path.join(directory_path, "publico-COMPLETO-100.txt.model")
...
df_join.to_excel("petroles_o&g_100.xlsx")    
#df["gpt"] = lista
